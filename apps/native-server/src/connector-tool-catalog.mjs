...
const knowledgeSearchTool = {
  ...
  description: 'Search the knowledge ranges and code repositories selected by the user for this Harness session through the unified retrieval API. The selected scope and continuation identity are not model-controlled.',
