...
test('review port accepts only exact versioned request and response shapes', () => {
  ...
  const actionRequest = { v: 1, type: 'markdown-review-session-action-request', requestId: 'request-action', reviewId: 'review-1', harnessSessionId: 'session-1', resourceId: 'resource-1', displayPath: 'docs/a.md', action: 'rewrite' }
