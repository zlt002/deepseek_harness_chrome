...
test('review tab offers five accessible stars with ten half-star choices linked to its generated PRD', () => {
  ...
  assert.match(main, /aria-label=\{`\$\{leftRating\} 星`\}/)
  assert.match(main, /aria-label=\{`\$\{rightRating\} 星`\}/)
  ...
  assert.match(main, /ratingPreview !== undefined \? `预览 \$\{ratingPreview\} 星`/)
  ...
  assert.match(style, /background: color-mix\(in srgb, #fff3cd/)
  assert.match(style, /box-shadow: 0 1px 3px/)
