...
type OfficeSpreadsheetAction = 'context' | 'range' | 'range_features' | 'search' | 'sheets' | 'defined_names' | 'capabilities' | 'view' | 'print_settings' | 'outline' | 'dimensions' | 'inspect_write' | 'write'
...
function isOfficeSpreadsheetRequest(message: NativeMessage): message is OfficeSpreadsheetRequest {
  ...
  if (!(message.type === 'connector_request' && typeof message.requestId === 'string' && typeof message.runId === 'string' && typeof message.generation === 'string'
    ...
    && ['context', 'range', 'range_features', 'search', 'sheets', 'defined_names', 'capabilities', 'view', 'print_settings', 'outline', 'dimensions', 'inspect_write', 'write'].includes(String(candidate.action)))) return false
