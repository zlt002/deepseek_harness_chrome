...
The model-facing roster tool is `list_work_tabs`. It lists the checked Browser Targets for this Run: live title, URL, editor kind, primary write target, and closed tabs. It does not load page bodies.
