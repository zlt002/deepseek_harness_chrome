...
import { HarnessWebProcess } from '../apps/native-server/src/runtime/harness-process.mjs'
...
import { Session, SessionId } from '../.generated/harness-product/packages/core/session/lib/index.js'
import SystemPrompt from '../.generated/harness-product/packages/core/system-prompt/lib/index.js'
import ToolRuntime from '../.generated/harness-product/packages/core/tools/lib/index.js'
import * as McpClient from '../.generated/harness-product/packages/mcp/mcp-client/lib/index.js'
...
test('the installed DSH MCP client discovers and executes the Connector tool through ToolRuntime', async () => {
  ...
  try {
    ...
    assert.deepEqual(ctx.tools.schemas().map((schema) => schema.name).sort(), [
      ...
      'mcp__chrome__presentation_get_capabilities',
      'mcp__chrome__presentation_get_context',
      'mcp__chrome__presentation_get_selection',
      'mcp__chrome__presentation_get_text_boxes',
      'mcp__chrome__presentation_write_commit',
      'mcp__chrome__presentation_write_preview',
      'mcp__chrome__read_work_tab',
      'mcp__chrome__selected_source_scope',
      'mcp__chrome__spreadsheet_get_context',
      'mcp__chrome__spreadsheet_inspect',
      'mcp__chrome__spreadsheet_read_range',
      'mcp__chrome__spreadsheet_search',
      'mcp__chrome__spreadsheet_write_commit',
      'mcp__chrome__spreadsheet_write_preview',
