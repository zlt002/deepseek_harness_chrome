...
test('accepts the official MCP client at the public tools/list and tools/call seam', async () => {
  ...
  try {
    ...
    assert.equal(Object.hasOwn(teamKnowledgeBatchPreview.inputSchema.properties, 'pmdReviewReceipt'), false)
