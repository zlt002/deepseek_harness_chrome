...
test('accepts the official MCP client at the public tools/list and tools/call seam', async () => {
  ...
  try {
    ...
    assert.deepEqual(tools.tools.map((tool) => tool.name), ['office_get_context', 'office_read_range', 'office_write_range', 'office_document', 'office_spreadsheet', 'team_doc_create', 'team_knowledge_item', 'pmd_prd_delivery', 'browser_open_tab', 'knowledge_search', 'code_search'])
