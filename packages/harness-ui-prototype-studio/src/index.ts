...
import { PROTOTYPE_STUDIO_BEGIN_GENERATION_PATH, PROTOTYPE_STUDIO_CANCEL_GENERATION_PATH, PROTOTYPE_STUDIO_CONFIRM_BRIEF_PATH, PROTOTYPE_STUDIO_CONFIRM_DESIGN_PATH, PROTOTYPE_STUDIO_OPEN_PATH, PROTOTYPE_STUDIO_RECOVER_PATH, PROTOTYPE_STUDIO_REOPEN_DESIGN_PATH, PROTOTYPE_STUDIO_RESTORE_PATH, PROTOTYPE_STUDIO_REVISION_PREVIEW_PATH, PROTOTYPE_STUDIO_SNAPSHOT_PATH } from './protocol.ts'
...
function verifiedRecoveryAssertion(value: unknown, signature: unknown, capability: unknown): { projectId: string; expectedSessionId: string; referenceId: string; evidenceFingerprint: string; expectedRecoveryEpoch: number; nonce: string; expiresAt: number } {
  ...
  return { projectId: item.projectId, expectedSessionId: item.expectedSessionId, referenceId: item.referenceId, evidenceFingerprint: item.evidenceFingerprint, expectedRecoveryEpoch: item.expectedRecoveryEpoch as number, nonce: item.nonce, expiresAt }
}
