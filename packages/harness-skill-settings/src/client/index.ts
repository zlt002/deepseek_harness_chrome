...
const zh = { nav: '技能', title: '技能管理', intro: '选择 Harness 如何使用已发现的技能。这里不会修改 SKILL.md，也不会影响其他 Agent。', loading: '正在加载技能…', noSession: '请先打开一个项目会话。', loadFailed: '技能设置加载失败。', saveFailed: '技能设置保存失败。', retry: '重试', empty: '没有发现可用技能。', enabled: '启用', manual: '仅手动', disabled: '停用', authorModel: '作者已禁止模型调用', authorUser: '作者已禁止手动调用', installTitle: '安装技能', installHint: '拖入一个 .zip 技能包或一个技能文件夹。安装不会覆盖同名技能。', chooseZip: '选择 ZIP', chooseFolder: '选择文件夹', installing: '正在安全安装技能…', installSuccess: '已安装 /{name}，正在刷新技能列表。', installReadOnly: '当前设置不可写，无法安装技能。', zipOnly: '请选择 .zip 技能压缩包。', zipTooLarge: '技能压缩包超过 16MB。', folderUnavailable: '当前浏览器不支持选择文件夹；请将技能文件夹拖入此区域。', oneItem: '一次只能安装一个技能压缩包或一个技能文件夹。' }
