...
const zh = { nav: '技能', title: '技能管理', loading: '正在加载技能…', noSession: '请先打开一个项目会话。', failed: '技能设置读取或保存失败。', enabled: '启用', manual: '仅手动', disabled: '停用', authorModel: '作者已禁止模型调用', authorUser: '作者已禁止手动调用' }
const en: typeof zh = { nav: 'Skills', title: 'Skill settings', loading: 'Loading skills…', noSession: 'Open a project session first.', failed: 'Could not load or save Skill settings.', enabled: 'Enabled', manual: 'Manual only', disabled: 'Disabled', authorModel: 'Author disabled model use', authorUser: 'Author disabled manual use' }
